...
% crop marks only if the variables have values and are not emtpy
% http://ctan.org/pkg/crop
% using cam crop marks, because these are invisible if no crop marks are used, when:
% \varCropPaperWidth = \varPaperWidth and \varCropPaperHeight = \varPaperHeight
\usepackage[
  % set width and height to a4 width and height + 6mm
  width=\varCropPaperWidth, height=\varCropPaperHeight,
...
% investigate further for improved layout options:
% http://ftp.snt.utwente.nl/pub/software/tex/macros/latex/contrib/layouts/
% \usepackage{layouts}
% https://www.ctan.org/pkg/layout
\usepackage{layout}
...
% Problem: small page sizes make justified text look ragged.
% http://tex.stackexchange.com/questions/100296/how-to-get-xelatex-do-proper-hyphenation-and-full-justification
...
%\setdefaultlanguage{\varBookLanguage}
\setdefaultlanguage{\varBookLanguage}
