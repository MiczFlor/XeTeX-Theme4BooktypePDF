...
\newcommand{\varPaperWidth}         {4.72in} 
\newcommand{\varPaperHeight}        {7.48in} 
\newcommand{\varBindingOffset}      {0cm} 
\newcommand{\varMarginTop}          {2cm} % measurement excluding header!
\newcommand{\varMarginBottom}       {2cm}
\newcommand{\varMarginLeft}         {1.2cm}
\newcommand{\varMarginRight}        {1.2cm}
